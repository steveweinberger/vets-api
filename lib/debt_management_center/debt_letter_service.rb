...
require 'debt_management_center/debt_letter_configuration'
require 'debt_management_center/responses/debt_letter_response'

module DebtManagementCenter
  class DebtLetterService < DebtManagementCenter::BaseService
    attr_reader :file_number

    configuration DebtManagementCenter::DebtLetterConfiguration
    ...
    def init_debts
      with_monitoring_and_error_handling do
        DebtManagementCenter::DebtLetterResponse.new(
