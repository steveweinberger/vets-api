...
RSpec.describe 'Webhooks Registration Endpoint', type: :request, retry: 3 do
  Settings.webhooks.enabled = true
  #  load('./modules/vba_documents/config/routes.rb')
  VALID_SUBSCRIPTIONS = File.read('./spec/fixtures/webhooks/subscriptions/subscriptions.json')
  ...
  describe '#subscribe /v1/register' do
    context 'reter' do
      before do
      ...
      #   post '/v1/webhooks.register', params: { webhook: VALID_SUBSCRIPTIONS }
      #   end
