...
class AppealsApi::RswagConfig
  ...
  def write_hlr_v2_schema!
    ...
    File.open(file_path, 'w') do |f|
      f.write("// Do not edit this file directly! It is generated by the rake rswag:appeals_api:run task\n\n")
      f.write(JSON.pretty_generate(schema))
    end
  end

  def write_nod_schema!
    schema = {
      '$schema': 'http://json-schema.org/draft-07/schema#',
      ...
      'definitions': [
        generic_schemas,
        nod_schemas('#/definitions')
      ].reduce(&:merge)
    }
    file_path = AppealsApi::Engine.root.join('config', 'schemas', 'v1', '10182.json')
    File.open(file_path, 'w') do |f|
      f.write("// Do not edit this file directly! It is generated by the rake rswag:appeals_api:run task\n\n")
      f.write(JSON.pretty_generate(schema))
    end
