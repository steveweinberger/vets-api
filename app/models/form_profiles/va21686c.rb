...
class ScrubbedString < Dry::Struct
  def coerce(value)
...
module VA21686c
  ...
  class FormDependent < Dry::Struct
    ...
    attribute :child_has_no_ssn, Types::Nominal::Bool
    attribute :child_has_no_ssn_reason, ScrubbedString
    attribute :attending_college, Types::Nominal::Bool
    attribute :disabled, Types::Nominal::Bool
  ...
  class FormCurrentMarriage < Dry::Struct
    ...
    attribute :spouse_is_veteran, Types::Nominal::Bool
    attribute :live_with_spouse, Types::Nominal::Bool
