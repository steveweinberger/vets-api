...
form_data = [['metadata', 'application/json', File.open(metadata)],
             ['content', 'application/pdf', File.open(pdf)],['attachment1', File.open(pdf)],
             ['attachment2','application/pdf', File.open(pdf)]]
